...
import { LuCalendar, LuDollarSign, LuUsers, LuChartBarIncreasing } from "react-icons/lu";
...
export function DashboardTab() {
  ...
  useEffect(() => {
    async function cargar() {
      ...
      setStats([
        { label: 'Reservas hoy',    value: String(rHoy.length),             Icon: LuCalendar,    color: 'text-emerald-700', bg: 'bg-emerald-50 ring-emerald-200' },
        { label: 'Ingresos del mes', value: MoneyUtils.formatear(ingresos),  Icon: LuDollarSign, color: 'text-sky-700',     bg: 'bg-sky-50 ring-sky-200' },
        { label: 'Total clientes',   value: String(clientes.length),         Icon: LuUsers,      color: 'text-purple-700',  bg: 'bg-purple-50 ring-purple-200' },
        { label: 'Ocupación hoy',    value: `${ocupacion}%`,                 Icon: LuChartBarIncreasing,  color: 'text-amber-700',   bg: 'bg-amber-50 ring-amber-200' },
      ])
    }
